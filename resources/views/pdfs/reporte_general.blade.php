...
<body class="bg-gray-100 p-6">
    <div class="report-container">
        <h1 class="text-4xl font-extrabold text-gray-900 text-center mb-6">Reporte General de Libros</h1>
        <p class="text-center text-gray-600 mb-8">Un resumen de todos los libros disponibles en el sistema.</p>
